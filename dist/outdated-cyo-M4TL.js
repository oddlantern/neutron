...
import { r as DIM, t as BOLD, u as RESET } from "./output-DN5bGOyX.js";
...
import { a as formatLevel2Results, c as buildWorkspaceDepsMap, i as formatLevel1Results, l as collectDeps, o as formatLevel3Results, r as formatJsonOutput, t as runLevel1, u as hasFlutterDeps } from "./level1-SvYwHBi_.js";
...
async function runOutdated(parsers, options = {}) {
	...
	if (skipped > 0) diag.warn(`${skipped} dep(s) could not be checked (registry timeout or error)`, { fix: "Re-run neutron outdated or check your network connection" });
	if (options.json) {
	...
	console.log(`${DIM}Run ${BOLD}neutron check${RESET} ${DIM}to verify version consistency.${RESET}\n`);
	return 0;
}
/**
...
//# sourceMappingURL=outdated-cyo-M4TL.js.map