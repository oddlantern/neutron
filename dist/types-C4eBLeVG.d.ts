...
import { S as LintTypescriptConfig, _ as LintDartConfig, b as LintPythonConfig, c as FormatDartConfig, d as FormatPythonConfig, f as FormatRustConfig, l as FormatGoConfig, p as FormatTypescriptConfig, u as FormatPhpConfig, v as LintGoConfig, x as LintRustConfig, y as LintPhpConfig } from "./schema-6LgP2m9L.js";

//#region src/plugins/types.d.ts
/** Standard action names shared across ecosystem plugins */
declare const STANDARD_ACTIONS: {
  readonly LINT: "lint";
...
interface ExecutablePipelineStep extends PipelineStep {
  /** Execute this step */
...
interface EcosystemPlugin {
   ...
   */
  execute(action: string, pkg: WorkspacePackage, root: string, context: ExecutionContext): Promise<ExecuteResult>;
  /**
   ...
   */
  canHandleDomainArtifact?(domain: string, artifact: string, pkg: WorkspacePackage, root: string): Promise<DomainCapability | null>;
  /**
...
interface DomainPlugin {
   ...
   */
  exportArtifact(source: WorkspacePackage, artifact: string, root: string, context: ExecutionContext): Promise<ExecuteResult>;
  /**
   ...
   */
  generateDownstream(artifact: string, targets: readonly WorkspacePackage[], root: string, context: ExecutionContext): Promise<readonly ExecuteResult[]>;
  /**
   ...
   */
  buildPipeline?(source: WorkspacePackage, artifact: string, targets: readonly WorkspacePackage[], root: string, context: ExecutionContext): Promise<readonly ExecutablePipelineStep[]>;
  /**
   * Suggest watch paths for a bridge during init.
...
interface ExecutionContext {
  ...
  readonly lintPython?: LintPythonConfig | undefined;
  /** Ecosystem-specific lint config for Rust */
  readonly lintRust?: LintRustConfig | undefined;
  /** Ecosystem-specific lint config for Go */
  readonly lintGo?: LintGoConfig | undefined;
  /** Ecosystem-specific lint config for PHP */
  readonly lintPhp?: LintPhpConfig | undefined;
  /** Ecosystem-specific format config for Python */
  readonly formatPython?: FormatPythonConfig | undefined;
  /** Ecosystem-specific format config for Rust */
  readonly formatRust?: FormatRustConfig | undefined;
  /** Ecosystem-specific format config for Go */
  readonly formatGo?: FormatGoConfig | undefined;
  /** Ecosystem-specific format config for PHP */
  readonly formatPhp?: FormatPhpConfig | undefined;
...
type NeutronPlugin = EcosystemPlugin | DomainPlugin;
//#endregion
export { ExecutablePipelineStep as a, NeutronPlugin as c, PipelineStepResult as d, STANDARD_ACTIONS as f, EcosystemPlugin as i, PipelineResult as l, DomainPlugin as n, ExecuteResult as o, WatchPathSuggestion as p, EcosystemHandler as r, ExecutionContext as s, DomainCapability as t, PipelineStep as u };
//# sourceMappingURL=types-C4eBLeVG.d.ts.map