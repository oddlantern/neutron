...
import { n as loadPlugins, t as PluginRegistry } from "./registry-CkoeCZGV.js";
import { t as detectPackageManager } from "./pm-detect-BtRYHQXQ.js";
import { a as printStartup, c as logChange, d as logStep, f as logWaiting, i as printBridgeSummary, l as logDebug, n as groupBridgesByArtifact, o as resolveBridges, r as matchesBridge, t as executeBridgeGroup, u as logFail } from "./runner-BNUJCJpw.js";
import { t as writeHooks } from "./hooks-BRiO790g.js";
...
async function runDev(parsers, options = {}) {
	...
	setTimeout(() => {
		import("./outdated-DO9vg-Z4.js").then(({ quickOutdatedCheck }) => quickOutdatedCheck(parsers)).then((msg) => {
...
//# sourceMappingURL=dev-fvbXLcFY.js.map