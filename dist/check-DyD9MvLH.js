...
import { n as promptVersionResolution } from "./prompt-Dr6OLFkP.js";
...
async function runCheck(parsers, options = {}) {
	...
	if (graph.bridges.length > 0) {
		const { checkStaleness } = await import("./staleness-BViqZReK.js");
...
//# sourceMappingURL=check-DyD9MvLH.js.map