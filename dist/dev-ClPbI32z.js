...
import { n as loadPlugins, t as PluginRegistry } from "./registry-D8lJM6oZ.js";
...
async function runDev(parsers, options = {}) {
	...
	setTimeout(() => {
		import("./outdated-CMMPZr5R.js").then(({ quickOutdatedCheck }) => quickOutdatedCheck(parsers)).then((msg) => {
...
//# sourceMappingURL=dev-ClPbI32z.js.map