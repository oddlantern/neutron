...
function filesToPackages(changedFiles, packages) {
	...
	for (const file of changedFiles) for (const [path] of packages) if (file.startsWith(path + "/") || file === path) affected.add(path);
	return affected;
}
/**
...
//# sourceMappingURL=affected-BZWmcamr.js.map