...
import { n as loadPlugins, r as isRecord, t as PluginRegistry } from "./registry-BG_Yc1It.js";
...
async function runPostInitCheck(parsers) {
	...
	const { buildWorkspaceGraph } = await import("./workspace-BD6E7qqa.js").then((n) => n.n);
	const { findVersionMismatches } = await import("./versions-CAkFDjVW.js").then((n) => n.r);
	const { loadLock } = await import("./lock-BquVeM_6.js").then((n) => n.n);
...
//# sourceMappingURL=init-C-lfs6dv.js.map