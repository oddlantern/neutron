...
const consumerSchema = z.union([z.string(), z.object({
	path: z.string(),
...
const formatRustSchema = z.object({
	...
	useSmallHeuristics: z.enum([
		"Default",
		"Off",
		"Max"
	]).optional()
}).passthrough();
const formatGoSchema = z.object({ simplify: z.boolean().optional() }).passthrough();
const formatPhpSchema = z.object({
...
//#endregion
export { configSchema as i, DESIGN_FORMATS as n, HOOK_NAMES as r, DEFAULT_COMMIT_TYPES as t };

//# sourceMappingURL=schema-BipwgjSu.js.map