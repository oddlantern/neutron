#!/usr/bin/env node
import { a as DIM, f as RESET, l as ORANGE, r as BOLD, s as GREEN } from "./version-DD8ow6ZL.js";
import { n as isRecord, t as printBanner } from "./bin.js";
import { t as loadConfig } from "./loader-D_GOykgb.js";
import { n as loadPlugins, t as PluginRegistry } from "./registry-A2P8MNDJ.js";
...
async function runPostInitCheck(parsers) {
	...
	const { buildWorkspaceGraph } = await import("./workspace-Ba_CMHN8.js").then((n) => n.n);
	const { findVersionMismatches } = await import("./versions-BZyXnbdh.js").then((n) => n.i);
	const { loadLock } = await import("./lock-D-3owqTU.js").then((n) => n.i);
...
async function cleanupReplacedTooling(root) {
	...
	const devDeps = isRecord(devDepsRaw) ? devDepsRaw : void 0;
	...
	if (depsToRemove.length > 0) {
		...
		if (answer) {
			...
			if (bin) spawnSync(bin, [...baseArgs, ...depsToRemove], {
				cwd: root,
				stdio: "inherit"
			});
		}
...
//# sourceMappingURL=init-BRCdVmkP.js.map