...
import { n as runCheck } from "./check-D_eQoQxg.js";
...
async function runPostInitCheck(parsers) {
	...
	const { buildWorkspaceGraph } = await import("./workspace-D0mjV9qy.js").then((n) => n.n);
...
function renderYaml(config) {
	...
	doc.commentBefore = " yaml-language-server: $schema=node_modules/@oddlantern/mido-cli/schema.json\n\n ─────────────────────────────────────────────────────────\n mido — Cross-ecosystem workspace configuration\n Docs: https://github.com/oddlantern/mido-cli\n ─────────────────────────────────────────────────────────";
...
//# sourceMappingURL=init-CNjd5Qgi.js.map