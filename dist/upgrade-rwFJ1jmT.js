import { a as GREEN, l as RED, r as DIM, t as BOLD, u as RESET } from "./output-DN5bGOyX.js";
import { t as loadConfig } from "./loader-DPbQYX0n.js";
import { t as buildWorkspaceGraph } from "./workspace-MAuyT2B8.js";
import { a as mergeLock, o as writeLock, r as loadLock } from "./lock-CWRUuEwv.js";
...
import { n as promptMultiSelect, t as confirmAction } from "./prompt-DoUcLmFP.js";
import { t as applyManifestUpdate } from "./manifest-writer-BwcLi-Sr.js";
import { c as buildWorkspaceDepsMap, d as stripRange, l as collectDeps, n as SEVERITY_COLOR, s as formatRiskBadge, t as runLevel1, u as hasFlutterDeps } from "./level1-SvYwHBi_.js";
...
async function runUpgrade(parsers, options = {}) {
	...
	for (const dep of selected) {
		...
		for (const pkgPath of dep.packages) if (await applyManifestUpdate(root, {
			...
			diag.warn(`Manifest update skipped: ${dep.name} in ${pkgPath}`, { fix: "Check package paths in neutron.yml" });
		}
	}
	...
	else diag.warn("Version consistency issues detected", { fix: "Run neutron check --fix to resolve" });
...
//# sourceMappingURL=upgrade-rwFJ1jmT.js.map